...
<#
.SYNOPSIS
    Manage Bitlocker end-to-end with and store each state separately in NinjaRMM.
    
.DESCRIPTION
    This script manages Bitlocker operations (enable, suspend, disable) on a specified volume,
    generates an HTML status card with Bitlocker details, and updates multiple NinjaRMM custom fields.
    The recovery key is stored in a secure custom field. Designed to run on a schedule
...
param(
    ...
    # Secure field name for storing recovery key
...
# =========================================
# END Block: Update Fields & Finalization
# =========================================
end {
    Write-Host "`n=== Section: Final Protectors ==="
    ...
    # Store RecoveryKey and CurrentProtectors
    ...
    Write-Log "INFO" "Bitlocker management and custom field updates completed"
}